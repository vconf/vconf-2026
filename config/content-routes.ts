...
/** 講者介紹（/speakers/[talkSlug]）；draft 的不列入，順序比照 talkNumber */
export const speakerRoutes: string[] = readContentFiles('speakers', '.md')
