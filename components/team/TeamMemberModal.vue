...
<template>
  <Teleport to="body">
    ...
    >
      ...
      >
        <div
          class="grid size-full place-items-center items-start overflow-hidden overscroll-contain px-6 pt-[51px] scrollbar scrollbar-thumb-vconf-scrollbar scrollbar-w-scrollbar md:items-center md:overflow-y-auto md:px-[44px] md:py-[51px]"
          data-lenis-prevent
          @click.self="emit('close')"
        >
          <div
            class="mx-auto h-[85svh] max-h-[710px] w-full max-w-[1032px] md:h-auto md:max-h-none"
          >
            <div class="relative flex h-full flex-col md:block md:h-auto">
              <!-- 關閉按鈕 -->
              <button
                type="button"
              ...
              <div
                v-if="member"
                class="flex min-h-0 flex-1 flex-col overflow-hidden rounded-[24px] bg-vconf-white font-serif md:block md:flex-none"
              >
                <div
                  class="min-h-0 flex-1 overflow-y-auto overscroll-contain px-4 py-6 scrollbar scrollbar-thumb-vconf-scrollbar scrollbar-w-scrollbar md:max-h-[575px] md:overflow-y-auto md:px-8 md:pb-[37px] md:pt-8 md:scrollbar-w-scrollbar-md"
                  data-lenis-prevent
                >
                  <div
